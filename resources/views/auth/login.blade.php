...
<head>
    <meta charset="utf-8" />
    <title>Log In | SDMGD Admin</title>
                ...
                <div class="card overflow-hidden">
                    <div class="row g-0 align-items-center">
                        <div class="col-lg-6 d-none d-lg-block p-2">
                            <img src="{{ asset('backend/images/sdmg.png') }}" alt="" class="img-fluid rounded h-200">
                        </div>
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                <div class="auth-brand p-4">
                                    <a href="{{ url('/') }}" class="logo-light">
                                        <img src="{{ asset('backend/images/ict.png') }}" alt="logo" height="100">
                                    </a>
                                    <a href="{{ url('/') }}" class="logo-dark">
                                        <img src="{{ asset('backend/images/ict.png') }}" alt="dark logo" height="100">
                                    </a>
                                </div>
...
<footer class="footer footer-alt fw-medium">
    <span class="text-dark">
        <script>document.write(new Date().getFullYear())</script> © ICT Division
    </span>
</footer>
