            ...
            <div class="card-body">
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tr>
                        ...
                        <td>{{$aboutData->title_bn}}</td>
                        <td>{!! Str::limit($aboutData->details, 30) !!}</td>
                        <td>{!! Str::limit($aboutData->details_bn, 30) !!}</td>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="title_bn" name="title_bn" value="{{$aboutData->title_bn}}"
                                                               class="form-control" placeholder="Enter Title" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="details_bn" rows="5" placeholder="Enter the Description">{{ strip_tags($aboutData->details_bn) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end">
                    ...
                    <form method="post" action="{{route('about.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label> Details Bn</label>
                                    <textarea class="form-control" rows="5" name="details_bn" placeholder="Enter the Description" name="body"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
