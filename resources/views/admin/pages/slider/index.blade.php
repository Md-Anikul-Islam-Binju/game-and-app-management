                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="type" class="form-select">
                                                            <option value="image" {{ $sliderData->status === 'image' ? 'selected' : '' }}>Image</option>
                                                            <option value="video" {{ $sliderData->status === 'video' ? 'selected' : '' }}>Videos</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
