...
<div class="wrapper">
    ...
    <div class="leftside-menu">
        <a href="{{route('dashboard')}}" class="logo logo-light">
            <span class="logo-lg">
                <img src="{{URL::to('backend/images/sdmg.png')}}" alt="logo" style="height: 50px;">
            </span>
            <span class="logo-sm">
                <img src="{{URL::to('backend/images/sdmg.png')}}" alt="small logo">
            </span>
        </a>
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPages">
                        <ul class="side-nav-second-level">
                            ...
                            @can('venue-list')
                            <li>
                                <a href="{{route('venue.section')}}">Venue</a>
                            </li>
                            @endcan
                            ...
                            @can('notice-list')
                            <li>
                                <a href="{{route('notice.section')}}">Notice</a>
                            </li>
                            @endcan
                            ...
                            <li>
                                <a href="{{route('project.category.section')}}">Project Category Section</a>
                            </li>
                            @endcan

                            @can('project-list')
                            <li>
                                <a href="{{route('project.section')}}">Project</a>
                            </li>
                            @endcan
                            @can('ott-list')
                                <li>
                                    <a href="{{route('ott.section')}}">Ott Platform</a>
                                </li>
                            @endcan
                            @can('message-list')
                                <li>
                                    <a href="{{route('message.section')}}">Message</a>
                                </li>
                            @endcan
                            @can('menu-list')
                                <li>
                ...
                @can('showcase-list')
                <li class="side-nav-item">
                    <a href="{{route('showcase.section')}}" class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarPages2">
                        <ul class="side-nav-second-level">
                            @can('project-file-category-list')
                                <li>
                                    <a href="{{route('project.file.category.section')}}">Category</a>
                                </li>
                            @endcan
                            @can('project-file-list')
                            <li>
                                <a href="{{route('project.file.section')}}">Project File</a>
                            </li>
                            @endcan
                        </ul>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © ICT Division</b>
                    </div>
                </div>
            </div>
        </footer>
